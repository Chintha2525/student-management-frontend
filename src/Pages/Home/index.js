...
export default function Home() {
  ...
  useEffect(() => {
    const getStudents = () => {
      axios
        .get("https://student-management-4esy.onrender.com/get")
        .then((res) => {
  ...
  const deleteUser = (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://student-management-4esy.onrender.com/delete/${id}`)
          .then((res) => {
  ...
  return (
    <div className="text-center mb-4">
      <h5 style={{ textAlign: "center", padding: "3rem" }}>Students Management</h5>
      <Link to="/add-student">
        <div className="col-4">
